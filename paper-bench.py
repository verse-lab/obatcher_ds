...
if not os.path.exists('results/avl_insert_only_results.csv'):
...
if not os.path.exists('results/avl_search_only_results.csv'):
...
if not os.path.exists('results/avl_90_10_results.csv'):
...
# In[ ]:
if not os.path.exists('results/avl_50_50_results.csv'):
...
if not os.path.exists('results/rb_insert_only_results.csv'):
...
if not os.path.exists('results/rb_search_only_results.csv'):
...
# In[ ]:
if not os.path.exists('results/rb_90_10_results.csv'):
...
if not os.path.exists('results/rb_50_50_results.csv'):
...
if not os.path.exists('results/treap_insert_only_results.csv'):
...
if not os.path.exists('results/treap_search_only_results.csv'):
...
if not os.path.exists('results/treap_90_10_results.csv'):
...
if not os.path.exists('results/treap_50_50_results.csv'):
...
if not os.path.exists('results/veb_insert_only_results.csv'):
...
if not os.path.exists('results/veb_search_only_results.csv'):
...
if not os.path.exists('results/veb_90_10_results.csv'):
...
if not os.path.exists('results/veb_50_50_results.csv'):
...
if not os.path.exists('results/xfast_insert_only_results.csv'):
...
if not os.path.exists('results/xfast_search_only_results.csv'):
...
if not os.path.exists('results/xfast_90_10_results.csv'):
...
if not os.path.exists('results/xfast_50_50_results.csv'):
...
if not os.path.exists('results/yfast_insert_only_results.csv'):
...
if not os.path.exists('results/yfast_search_only_results.csv'):
...
if not os.path.exists('results/yfast_90_10_results.csv'):
...
if not os.path.exists('results/yfast_50_50_results.csv'):
...
if not os.path.exists('results/skiplist_insert_only_results.csv'):
...
if not os.path.exists('results/skiplist_search_only_results.csv'):
...
if not os.path.exists('results/skiplist_50_50_results.csv'):
...
if not os.path.exists('results/skiplist_90_10_results.csv'):
...
if not os.path.exists('results/btree_insert_only_results.csv'):
...
if not os.path.exists('results/btree_search_only_results.csv'):
...
if not os.path.exists('results/btree_50_50_results.csv'):
...
if not os.path.exists('results/btree_90_10_results.csv'):
...
if not os.path.exists('results/datalog_results.csv'):
